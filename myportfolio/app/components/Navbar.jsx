  ...
  return (
    <>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between bg-white z-50 shadow-md ${isScroll ? 'bg-white bg-opacity-50 backdrop-blur-lf shadow-sm' : ''}`}>
        <a href="#top">
          <Image src={assets.logo} alt="Website logo" className="w-33 cursor-pointer mr-14" />
        </a>

        {/* Desktop Navigation */}
        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50"} `}>
          <li>
            <a className="font-Ovo text-2xl" href="#top">Home</a>
          </li>
          <li>
            <a className="font-Ovo text-2xl" href="#about-me">About Me</a>
          </li>
          <li>
            <a className="font-Ovo text-2xl" href="#work">My Work</a>
          </li>
          <li>
            <a className="font-Ovo text-2xl" href="#contact">Contact Me</a>
          </li>
        </ul>
        {/* Mobile Navigation */}
