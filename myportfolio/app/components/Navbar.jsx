...
//       <nav className={`/* Base styles */ w-full  fixed  px-4 py-3 flex items-center justify-between bg-white z-50  shadow-md transition-all duration-300
//       /* Mobile styles (default) */ flex-wrap md:flex-nowrap /* Padding for different screen sizes */ sm:px-5 lg:px-8 xl:px-[8%] /* Conditional background on scroll */
...
//           <li>
//             <a className="font-Ovo text-xl" href="#top">Home</a>
//           </li>
//           <li>
//             <a className="font-Ovo text-xl" href="#about-me">About Me</a>
//           </li>
//           <li>
//             <a className="font-Ovo text-xl" href="#work">My Work</a>
//           </li>
//           <li>
//             <a className="font-Ovo text-xl" href="#contact">Contact Me</a>
//           </li>
//         </ul>
//         {/* Mobile Navigation */}
