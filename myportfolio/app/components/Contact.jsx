...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "508f49ad-369e-4fcd-828a-1b32931c5840");
  ...
  return (
    ...
    bg-[length:90%_auto] '>
        ...
        <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
            ...
            -none border-[0.5px] border-gray-400 rounded-md bg-white' name='name'/>
            ...
            -none border-[0.5px] border-gray-400 rounded-md bg-white' name='message' >

            </textarea>
            <button type='submit' className="py-3 px-8 w-max flex items-center 
                justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500">
                Submit now <Image src={assets.right_arrow_white} alt='Submit button' className='w-4'/>
            </button>
